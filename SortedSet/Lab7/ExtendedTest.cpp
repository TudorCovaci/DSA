...
void testAllExtended() {
	...
	std::cout << "Remove1 finished\n";
	testRemove(rGreater);
	std::cout << "Remove2 finished\n";
	testIterator(rLessEqual);
	std::cout << "Iterator1 finished\n";
	testIterator(rGreater);
	std::cout << "Iterator2 finished\n";
	testQuantity(rLessEqual);
	std::cout << "Quantity1 finished\n";
	testQuantity(rGreater);
	std::cout << "Quantity2 finished\n";
